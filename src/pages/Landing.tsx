...
import { Database, Zap, Users, Shield, BarChart3, Wrench, ArrowRight, Code, Lock, Cpu, TrendingUp, Sparkles, CheckCircle2, Flame, Clock, Star, Rocket, Gift, Calendar, Building2, Leaf, AlertCircle, Zap as ZapIcon } from 'lucide-react';
...
export function Landing() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white overflow-hidden">
      ...
      {/* Navigation */}
      <nav className="relative z-50 flex items-center justify-between px-6 py-4 border-b border-slate-700/50 backdrop-blur-md bg-slate-900/50">
        <div className="flex items-center space-x-3">
          <div className="relative">
            <Wrench className="h-8 w-8 text-amber-500 animate-bounce" style={{animationDelay: '0s'}} />
      ...
      <section className="relative z-10 px-6 py-20 max-w-7xl mx-auto text-center">
        {/* Urgency Badge */}
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full animate-pulse">
          <Rocket className="h-4 w-4 text-red-500" />
          <span className="text-sm font-bold text-red-400">5,000+ Garages Already Connected</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
          <button
            onClick={() => navigate('/login')}
            className="px-10 py-4 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 rounded-lg font-black text-lg transition-all duration-200 hover:shadow-2xl hover:shadow-amber-500/50 flex items-center justify-center gap-2 transform hover:scale-105 active:scale-95"
          >
            <Gift className="h-5 w-5" />
            Unlock Free API Access
            <ArrowRight className="h-5 w-5" />
          </button>
          <button
            onClick={() => document.getElementById('success-stories')?.scrollIntoView({ behavior: 'smooth' })}
            className="px-10 py-4 border-2 border-amber-500 hover:bg-amber-500/10 rounded-lg font-bold text-lg transition-all duration-200"
          >
            See What's Possible
          </button>
        </div>
      ...
      <section className="relative z-10 px-6 py-16 bg-gradient-to-r from-blue-900/50 to-slate-900/50 border-y border-slate-700/50">
      ...
      <section id="success-stories" className="relative z-10 px-6 py-20 max-w-7xl mx-auto">
        <h2 className="text-4xl font-black mb-12 text-center">
          <Sparkles className="inline h-8 w-8 text-amber-400 mr-2 animate-spin" />
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {[
            ...
            <div
              key={idx}
              className="relative group bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-8 rounded-xl border border-amber-500/20 hover:border-amber-500/50 transition-all duration-300 overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <story.icon className="h-12 w-12 text-amber-400 mb-4" />
                <p className="font-bold text-amber-400 text-lg mb-2">{story.stat}</p>
                <p className="text-sm text-gray-300 mb-4">{story.detail}</p>
      ...
      <section className="relative z-10 px-6 py-20 bg-gradient-to-b from-slate-900 to-blue-900/30">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-4xl font-black mb-4 text-center">
            Unlock Every Feature
          </h2>
          <p className="text-center text-gray-400 mb-16 text-lg">Everything you need starts at zero cost</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <div
                  key={idx}
                  className={`relative group bg-gradient-to-br from-slate-700/50 to-slate-800/50 p-8 rounded-xl border border-slate-600 hover:border-amber-500 transition-all duration-300 overflow-hidden transform hover:scale-105 ${
                ...
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className={`px-3 py-1 bg-${feature.color}-500/20 border border-${feature.color}-500/50 rounded-full text-xs font-bold text-${feature.color}-400`}>
                        {feature.badge}
                      </div>
                    </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-cyan-500/10 border border-cyan-500/30 rounded-full">
              ...
              <span className="text-sm font-bold text-cyan-400">The Core Power</span>
            </div>
            ...
            <div className="space-y-3 mb-8">
              {[
                ...
                <div key={idx} className="flex items-center gap-3 group hover:translate-x-2 transition-transform">
                  ...
                  <span className="text-gray-300 group-hover:text-amber-400 transition-colors">{item}</span>
                  <div className="ml-auto text-xs text-gray-600 flex items-center gap-1"><span className="text-amber-400">{idx + 1}</span></div>
                </div>
              ))}
            </div>
            ...
            <button
              onClick={() => navigate('/login')}
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 rounded-lg font-black text-lg transition-all duration-200 hover:shadow-2xl hover:shadow-cyan-500/50 transform hover:scale-105 active:scale-95"
            >
          ...
          <div className="relative group">
            ...
            <div className="relative bg-slate-900 border border-cyan-500/30 p-6 rounded-lg overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/20 blur-2xl"></div>
              <pre className="text-sm text-cyan-300 overflow-x-auto relative z-10">
{`// 3 lines to connect
...
// It's that simple.`}
              ...
              <div className="mt-4 pt-4 border-t border-slate-700 text-xs text-gray-500 flex items-center gap-2">
      ...
      <section className="relative z-10 px-6 py-20 bg-gradient-to-b from-blue-900/30 to-slate-900">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Visual Element */}
            ...
            <div>
              <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full">
                ...
                <span className="text-sm font-bold text-orange-400">Built-In Tools</span>
              </div>
              <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">
                Dashboard Included
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div key={idx} className="flex items-center gap-3 p-3 bg-slate-700/50 hover:bg-slate-700 rounded-lg transition-colors group">
                  <item.icon className="h-5 w-5 text-amber-400 group-hover:scale-125 transition-transform" />
                    <span className="text-sm font-semibold text-gray-300 group-hover:text-amber-400">{item.label}</span>
                  </div>
                ))}
              </div>
              ...
              <button
                onClick={() => navigate('/login')}
                className="px-8 py-4 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 rounded-lg font-black text-lg transition-all duration-200 hover:shadow-2xl hover:shadow-orange-500/50 transform hover:scale-105 active:scale-95"
              >
      ...
      <section className="relative z-10 px-6 py-24 max-w-4xl mx-auto text-center">
        <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full animate-pulse">
          ...
          <span className="text-sm font-bold text-red-400">Join the Movement</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          <button
            onClick={() => navigate('/login')}
            className="pulse-button px-12 py-5 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-400 hover:to-orange-500 rounded-xl font-black text-xl transition-all duration-200 hover:shadow-2xl hover:shadow-amber-500/50 transform hover:scale-105 active:scale-95 flex items-center justify-center gap-3"
          >
            <Rocket className="h-6 w-6" />
            Get Started Free Right Now
            <ArrowRight className="h-6 w-6" />
          </button>
          <button
            onClick={() => navigate('/login')}
            className="px-12 py-5 border-3 border-amber-500 hover:bg-amber-500/5 rounded-xl font-black text-lg transition-all duration-200"
          >
            Book a Demo
          </button>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-400 mb-4 flex items-center justify-center gap-4 flex-wrap">
            <span className="flex items-center gap-1"><CheckCircle2 className="h-4 w-4 text-green-400" />Free forever tier available</span>
            <span>|</span>
            <span className="flex items-center gap-1"><CheckCircle2 className="h-4 w-4 text-green-400" />No credit card required</span>
            <span>|</span>
            <span className="flex items-center gap-1"><CheckCircle2 className="h-4 w-4 text-green-400" />Cancel anytime</span>
          </p>
        </div>
      </section>

      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-700/50 py-12 px-6 text-center text-gray-400">
        <div className="max-w-7xl mx-auto">
          <p className="mb-4">&copy; 2026 CAR4GE. Building the future of garage systems.</p>
