...
type Garage = Database['public']['Tables']['garages']['Insert'];
            ...
            <div className="mt-3 w-full text-center sm:mt-0 sm:text-left">
              <div className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Register a new garage location</p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm transition-all duration-200 hover:shadow-md"
                  />
                </div>
                ...
                {error && (
                  <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-red-600 text-sm text-center animate-in slide-in-from-top-2 duration-200">
                    {error}
                  </div>
                )}
